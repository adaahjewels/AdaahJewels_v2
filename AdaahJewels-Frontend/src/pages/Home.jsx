  ...
  return (
    <PageTransition variant="slideUp">
      <div className="min-h-screen">
          ...
          <section className="py-16 bg-white">
            <div className="container mx-auto px-4">
              <div className="text-center mb-10">
                <h2 className="text-3xl section-heading mb-2">
                  Shop by Category
                </h2>
                <p className="text-sm" style={{ color: 'var(--color-ink-muted)' }}>
                  Curated collections crafted for every occasion
                </p>
                <div
                  className="w-24 h-0.5 mx-auto mt-4"
                  style={{ background: 'linear-gradient(to right, transparent, var(--color-brand-400), transparent)' }}
                />
              </div>
              {categoriesLoading ? (
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  {categories.map((category) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className="aspect-square rounded-2xl overflow-hidden mb-4 card-shadow mx-auto relative"
                          style={{
                            maxWidth: '160px',
                            border: '2px solid var(--color-brand-100)',
                            background: 'linear-gradient(160deg, var(--color-cream-100), var(--color-brand-50))',
                          }}
                        >
                          <img
                            src={catImage}
                ...
                >
                  ...
                  <p className="text-xs mt-1" style={{ color: 'var(--color-ink-muted)' }}>
                    New collections are being prepared. Please check back shortly.
                  </p>
                </div>
              )}
            </div>
        ...
        <FadeInWhenVisible>
          <section className="py-20" style={{ background: 'var(--color-brand-50)' }}>
            <div className="container mx-auto px-4">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-16">
                <div>
                  <h2 className="text-4xl section-heading mb-3 text-left font-display font-bold">Bestsellers</h2>
                  <div
                ...
                <Link
                  to="/products"
                  className="mt-4 md:mt-0 text-sm font-semibold transition-all hover:gap-2 flex items-center gap-1"
        ...
        >
          <div className="container mx-auto px-4 text-center">
            <motion.h2
              ...
              style={{ color: 'var(--color-gold-300)', textShadow: '0 2px 10px rgba(0,0,0,0.35)' }}
              initial={{ scale: 0.9 }}
              whileInView={{ scale: 1 }}
            ...
            <p className="text-base mb-3" style={{ color: 'var(--color-cream-100)' }}>
...
function DynamicCouponBanner() {
  ...
  if (!coupon) return (
    <p
      className="inline-flex items-center gap-2 text-base md:text-lg font-bold font-display tracking-wide px-4 py-2 rounded-xl"
      style={{
  ...
  return (
    ...
    >
      Use code:
      <span className="px-2.5 py-1 rounded-lg text-sm" style={{ background: 'var(--color-gold-500)', color: 'var(--color-brand-900)' }}>
        {coupon.code}
      </span>
    </p>
  );
